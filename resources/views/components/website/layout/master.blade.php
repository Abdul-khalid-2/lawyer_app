@props([
    'title' => 'Law-Skoolyst - Find the Right Lawyer & Legal Expert for Your Case',
    'description' => 'Connect with verified lawyers, legal experts, and attorneys. Get professional legal advice, case consultation, and find the perfect lawyer for your specific needs.',
    'ogImage' => null,
])
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <meta property="og:image" content="{{ $ogImage ?? asset('website/images/og-image.jpg') }}">
    ...
    <meta property="twitter:image" content="{{ $ogImage ?? asset('website/images/twitter-image.jpg') }}">
...
<body {{ $attributes }}>
    ...
    {{-- Flash payload consumed by js/website/modules/flash-messages.js --}}
    <script type="application/json" id="lc-flash">@json(['success' => session('success'), 'error' => session('error')])</script>
